...
//
//    var duplicateFree = _.uniq(array);
//    return _.sortBy(duplicateFree);
//
// };
//
// var sortedSkills = sorted(skills);
//
...
var DataWork = (function () {
    ...
    DataWork.prototype.getSkills = function () {
        var listSkills = [];
    ...
    DataWork.prototype.getNamesOrderByCountFriends = function () {
        var listUsers = [];
    ...
    DataWork.prototype.getFriendsAllUsers = function () {
        var listFriends = [];
        _(this.data).forEach(function(user) {
...
app = new DataWork(data);

console.log('Массив скилов (поле skills) всех людей', app.getSkills());
console.log('Массив имён (поле name) людей', app.getNamesOrderByCountFriends());
console.log('Массив друзей всех пользователей', app.getFriendsAllUsers());